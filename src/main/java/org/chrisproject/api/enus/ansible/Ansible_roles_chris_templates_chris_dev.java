 ...
 * DisplayName.enUS: ChRIS_ultron_backEnd/ansible/roles/chris/templates/chris_dev.service
 * Map.hackathonLabel: create_dev_service_template
 * Map.hackathonMission: Ansible script
 * Map.hackathonTitle: define the ChRIS dev systemd service file. 
 * Map.hackathonColumn: Automate dev
 * Map.hackathonLabels: ansible,yml
 */
public class Ansible_roles_chris_templates_chris_dev {

	/**
	 * DisplayName.enUS: create the code
	 * enUS: Create a new file: /usr/local/src/ChRIS_ultron_backEnd/ansible/roles/chris/templates/chris_dev.service
	 * enUS: 
	 * enUS: 
	 */
	public void part1() {
