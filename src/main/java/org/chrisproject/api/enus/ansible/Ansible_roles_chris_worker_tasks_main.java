 ...
 * Map.hackathonMission: Automate the deployment of ChRIS worker as a Podman container running as a Systemd service. 
 * Map.hackathonTitle: define the Ansible tasks to install the worker application as a container in podman. 
